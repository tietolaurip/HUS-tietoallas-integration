package fi.tietoallas.integration.incremental.cressidaods.config;
...
public class SourceDbConfig {
    ...
    public SourceDbConfig(@Autowired Environment environment){
    ...
    public DataSource dataSource(){
        ...
        if (environment.getProperty("fi.datalake.sourcedb.driver") != null){
            ...
            //cressida is runs on top of oracle so we can use default 
