...
public class Table {
    ...
    @javax.persistence.Column(name = "orig_table_name")
    protected String origTableName;
    @javax.persistence.Column(name = "data_set_name")
    protected String dataSetName;
    protected String description;
    @javax.persistence.Column(name = "table_constraints")
    protected String tableConstraints;
    @javax.persistence.Column(name = "timestamp_column")
    ...
    @javax.persistence.Column(name = "deletion_marker_column")
